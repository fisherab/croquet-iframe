...
class Croquet_Iframe {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Croquet_Iframe_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Croquet_Iframe_Loader. Orchestrates the hooks of the plugin.
	 * - Croquet_Iframe_i18n. Defines internationalization functionality.
	 * - Croquet_Iframe_Admin. Defines all hooks for the admin area.
	 * - Croquet_Iframe_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Croquet_Iframe_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Croquet_Iframe_Loader    Orchestrates the hooks of the plugin.
	 */
